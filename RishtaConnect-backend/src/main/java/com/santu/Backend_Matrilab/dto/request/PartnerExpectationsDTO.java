...
public class PartnerExpectationsDTO {
    ...
    // Constructor
    public PartnerExpectationsDTO(Long id, Long userId, String generalRequirement, Integer preferredMinAge, Integer preferredMaxAge,
                                  Double preferredMinHeight, Double preferredMaxHeight, Double preferredMaxWeight,
                                  String preferredComplexion, String preferredEducation, String preferredOccupation,
                                  String preferredLanguages, String preferredPersonality,
                                  String preferredFamilyValues) {
        this.id = id;
        this.userId = userId;
